...
import {IModalProps, IOptionData} from './Modal.props';
    ...
    <Modal
      ...
      <Block style={[root]}>
        <Block style={[wrapOption]}>
          ...
          {option.map((item: IOptionData, index: number) => {
            return (
              <Button
                style={[styles.option]}
...
export const ActionSheet = memo(ModalComponent, equals);
